...
// Import modals (will be implemented next)
...
export default function NotificationList() {
  ...
  return (
    <div className="notification-page">
      <div className="notification-card">
        <div className="notification-header">
          <div className="notification-header-title">
            ...
            <p className="subtitle">Tạo và gửi thông báo cho Ban quản lý và Kế toán</p>
          </div>
                ...
                <tr>
                  <td colSpan={5}>
                    <div className="notification-empty">
                      ...
                      <p>Nhấp vào "Tạo thông báo" để bắt đầu soạn thông báo mới cho quản lý và kế toán.</p>
                    </div>
                  </td>
                </tr>
              ) : (
      ...
      {/* Modals placeholders - to be implemented */}
