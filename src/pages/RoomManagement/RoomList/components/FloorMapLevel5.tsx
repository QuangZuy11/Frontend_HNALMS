...
export default function FloorMapLevel5({ rooms, floorName, highlightedRooms, compact = false }: FloorMapLevel5Props & { highlightedRooms?: Room[], compact?: boolean }) {
    ...
    return (
        <div className={`floor-map-container level-5 ${compact ? "compact" : ""}`}>
            ...
            <div className="map-layout-l5">
                <div className="grid-l5">
