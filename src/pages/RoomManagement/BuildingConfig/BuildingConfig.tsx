...
const BuildingConfig = () => {
  ...
  const [viewingHistoryType, setViewingHistoryType] = useState<RoomType | null>(
    null,
  );
  ...
  const totalRooms = floors.reduce(
    (acc, floor) => acc + (floor.roomCount || 0),
    0,
  );
  ...
  const prevImage = useCallback(() => {
    if (currentImages.length > 0) {
      setPhotoIndex(
        (prev) => (prev + currentImages.length - 1) % currentImages.length,
      );
    }
  }, [currentImages]);
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            Quản lý danh sách tầng và các hạng mục loại phòng
          </p>
        </div>
                ...
                {roomTypes.map((type) => (
                  <tr key={type._id}>
                    ...
                    <td className="text-price">
                      {formatCurrency(type.currentPrice)}
                    </td>
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setTypeForm({
                        ...typeForm,
                        personMax: Number(e.target.value),
                      })
                    }
                    required
                  />
            ...
            <div className="detail-body">
              <div className="detail-info-grid">
                <div className="info-item">
                  <label>Tên loại phòng</label>
                  <div className="info-value text-bold">
                    {viewingType.typeName}
                  </div>
                </div>
                <div className="info-item">
                  <label>Giá hiện tại</label>
                  <div className="info-value text-price">
                    {formatCurrency(viewingType.currentPrice)}
                  </div>
                </div>
                <div className="info-item">
                  <label>Số người tối đa</label>
                  <div className="info-value">
                    {viewingType.personMax} người
                  </div>
                </div>
                <div className="info-item full-width">
                  <label>Mô tả</label>
                  <div className="info-value text-desc">
              ...
              <div className="detail-images-section">
                <label className="section-label">
                  Hình ảnh ({viewingType.images?.length || 0})
                </label>
            ...
            <div className="modal-actions">
              ...
              <button
                ...
                onClick={() => {
                  ...
                  handleOpenTypeModal(viewingType);
                }}
              >
      ...
      {showHistoryModal && viewingHistoryType && (
        <div className="modal-overlay" style={{ zIndex: 1100 }}>
          <div className="modal-content" style={{ maxWidth: "600px" }}>
            ...
            <div className="detail-body">
              {viewingHistoryType.histories &&
              viewingHistoryType.histories.length > 0 ? (
                <div className="history-list">
                  ...
                  {[...viewingHistoryType.histories]
                    ...
                    .map((history, idx) => (
                      <div
                        key={history._id}
                        className={`history-item ${!history.endDate ? "current" : ""}`}
                      >
                        ...
                        <div className="history-date">
                          {history.endDate ? (
                            ...
                            <span className="tag-active">Đang áp dụng</span>
                          )}
                        </div>
